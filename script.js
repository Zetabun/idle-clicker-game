(function() {
  ...
  let fuelRanOutLogged = false; // prevents duplicate fuel-out log entries
  ...
  function drawCarCanvas() {
    ...
    const bobbingOffset = (game.car.fuel > 0 && game.car.miles !== 0) ? 2 * Math.sin(globalTime * 2 * Math.PI) : 0;
    ctx.save();
