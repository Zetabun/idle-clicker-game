(function() {
  ...
  game.car = {
    ...
    weatherIndex: 0,
    environmentOffset: 0,
    // direction: 1 => forward, -1 => returning home, 0 => stationary at home
    direction: 1
  };
  ...
  // Log functions store the colored HTML snippet so that colors persist on reload
  ...
  // Update trunk inventory overlay (items shown without a "Use" button)
  ...
  // Draw additional background items (e.g., buildings, dunes)
  ...
  // Shift loot positions based on car movement
  ...
  function updateDisplay() {
    ...
    // Ensure the Resume Journey button is visible when the car is home
