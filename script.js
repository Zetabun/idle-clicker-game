(function() {
  ...
  // Update the trunk overlay (items without a Use button)
  ...
  function updateDisplay() {
    ...
    // Ensure Resume Journey is always visible when the car is at the garage (miles === 0)
    if (game.car.miles === 0) {
  ...
  function loadGame() {
    ...
    // Always show Resume Journey if miles are 0
    if (game.car.miles === 0) {
      startJourneyButton.style.display = "inline-block";
      returnHomeButton.style.display = "none";
      game.car.direction = 0;
  ...
  function loadGame() {
    ...
    // Always show the Resume Journey button when car is at home (miles = 0)
    if (game.car.miles === 0) {
      startJourneyButton.style.display = "inline-block";
      returnHomeButton.style.display = "none";
      game.car.direction = 0;
