...
wr(p,t.rstrip()+block)
p=S/'build.py'; t=rd(p); t=rep(t,'"game_css_lines_max": 31055,','"game_css_lines_max": 31090,','css lines'); t=rep(t,'"important_declarations_max": 2240,','"important_declarations_max": 2245,','important'); t=rep(t,'"media_queries_max": 481,','"media_queries_max": 482,','media'); wr(p,t)
