...
wr(p,t.rstrip()+block)
p=S/'build.py'; t=rd(p); t=rep(t,'"game_css_lines_max": 31020,','"game_css_lines_max": 31055,','css lines'); t=rep(t,'"important_declarations_max": 2215,','"important_declarations_max": 2225,','important'); t=rep(t,'"media_queries_max": 480,','"media_queries_max": 481,','media'); wr(p,t)
